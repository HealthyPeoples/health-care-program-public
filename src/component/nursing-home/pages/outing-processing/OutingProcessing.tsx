			...
			<div className="mx-auto max-w-[1600px] p-4">
				...
				<div className="border border-blue-300 rounded-lg bg-white shadow-sm">
					<div className="bg-blue-100 border-b border-blue-300 px-4 py-2">
						<h2 className="text-lg font-semibold text-blue-900">외출/외박 처리</h2>
					</div>
						...
						<table className="w-full text-sm">
							<thead className="bg-blue-50 border-b border-blue-200 sticky top-0">
								<tr>
									...
									<th className="text-center px-3 py-2 text-blue-900 font-semibold border-r border-blue-200">연락처</th>
									<th className="text-center px-3 py-2 text-blue-900 font-semibold">수정</th>
								</tr>
							</thead>
							<tbody>
