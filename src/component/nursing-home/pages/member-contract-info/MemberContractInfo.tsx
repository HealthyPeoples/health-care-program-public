							...
							<div className="p-4">
								<div className="grid grid-cols-12 gap-4">
									...
									<div className="col-span-12 grid grid-cols-12 gap-3">
										...
										{/* 2행 */}
										<div className="col-span-12 md:col-span-6 flex items-center gap-2">
											<label className="w-24 px-2 py-1 text-sm bg-blue-100 border border-blue-300 rounded text-blue-900">요양급여</label>
											<input className="flex-1 border border-blue-300 rounded px-2 py-1 bg-white" />
										</div>
										<div className="col-span-12 md:col-span-6 flex items-center gap-2">
										...
										{/* 3행 */}
										<div className="col-span-12 md:col-span-6 flex items-center gap-2">
											<label className="w-24 px-2 py-1 text-sm bg-blue-100 border border-blue-300 rounded text-blue-900">계약상태</label>
						...
						<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
							...
							<div className="border border-blue-300 rounded-lg bg-white shadow-sm">
								...
								<div className="p-4 space-y-2 text-sm">
									<div className="flex items-center gap-2"><span className="w-24 text-blue-900/80">기본급여</span><span className="flex-1 border-b border-blue-200" /></div>
									<div className="flex items-center gap-2"><span className="w-24 text-blue-900/80">추가급여</span><span className="flex-1 border-b border-blue-200" /></div>
									<div className="flex items-center gap-2"><span className="w-24 text-blue-900/80">특별급여</span><span className="flex-1 border-b border-blue-200" /></div>
									<div className="flex items-center gap-2"><span className="w-24 text-blue-900/80">총급여</span><span className="flex-1 border-b border-blue-200" /></div>
								</div>
							</div>
							...
							<div className="border border-blue-300 rounded-lg bg-white shadow-sm">
								...
								<div className="p-4 space-y-2 text-sm">
									<div className="flex items-center gap-2"><span className="w-24 text-blue-900/80">본인부담률</span><span className="flex-1 border-b border-blue-200" /></div>
									<div className="flex items-center gap-2"><span className="w-24 text-blue-900/80">부담금액</span><span className="flex-1 border-b border-blue-200" /></div>
									<div className="flex items-center gap-2"><span className="w-24 text-blue-900/80">면제사유</span><span className="flex-1 border-b border-blue-200" /></div>
									<div className="flex items-center gap-2"><span className="w-24 text-blue-900/80">납부상태</span><span className="flex-1 border-b border-blue-200" /></div>
								</div>
							</div>
						</div>
					</section>
