/**
 * @file API /api/f51012 — 연계/사례 F51012
 *
 * @description
 * 연계/사례 F51012 Next.js Route Handler. 세션 ANCD 게이트·MSSQL 직접 접근 패턴을 따릅니다.
 *
 * @module app/api/f51012/route
 */
...
export async function POST(req) {
	try {
		...
		if (!ymd) {
			return jsonError({ success: false, error: 'RQDT(작성일자)가 필요합니다.' }, 400);
		}
