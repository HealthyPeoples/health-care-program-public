/**
 * @file API /api/f30111 — 투약시간 F30111
 *
 * @description
 * 투약시간 F30111 Next.js Route Handler. 세션 ANCD 게이트·MSSQL 직접 접근 패턴을 따릅니다.
 *
 * @module app/api/f30111/route
 */
  ...
  try {
    ...
    const data = {
      ...
      times: {
        ...
        아침식후: mapTimeFromDb(row, "MOOUT", "MOOUT_TIME", "MOOUT_NAME"),
    ...
    await request.query(`
      ...
      BEGIN
        INSERT INTO [돌봄시설DB].[dbo].[F30111] (
          ...
          [MOIN_TIME],[MOIN_NAME],[MOOUT_TIME],[MOOUT_NAME],
